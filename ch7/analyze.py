"""The analyze module uses the Flesch-Kincaid readability test to analyze text and produce a readability score. 
   This score is then converted into a grade-based readability category
"""
...
def count_sentences(text):
    ...
    a heurstic and may not be 100% accurate.
    """
    count = 0
...
def count_syllables(words):
    """This function takes a list of words and returns a total count of syllables across
...
def output_results(score):
    """This function takes a Fleasch-Kincaid score and prints the
